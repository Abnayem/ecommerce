               ...
               <div class="table-responsive">
                 ...
                 @foreach($list as $data)
                      ...
                      @endif
                        ...
                        <td id="total_price_{{$data->attr_id}}">Tk{{$data->price*$data->qty}}</td>
                      </tr>
                   @endforeach
                      <tr>
                        <td colspan="6" class="aa-cart-view-bottom">
                        <a class="aa-cartbox-checkout aa-primary-btn" href="{{'/checkout'}}">                        <input class="aa-cart-view-btn" type="button" value="Checkout">
                         </a>
                        </td>
                      </tr>
                      </tbody>
