            ...
            <div class="aa-header-bottom-area">
              ...
              <div class="aa-cartbox">
                ...
                <div class="aa-cartbox-summary">
                  ...
                  <ul>
                    @foreach($getAddToCartTotalItem as $totalCart)
                    @php
                    $totalPrice = $totalPrice+($totalCart->qty*$totalCart->price)
                    @endphp
                    <li>
                      <a class="aa-cartbox-img" href="#"><img src="{{asset('storage/media/'.$totalCart->image)}}" alt="img"></a>
                      <div class="aa-cartbox-info">
                        <h4><a href="#">{{$totalCart->name}}</a></h4>
                        <p>{{$totalCart->qty}} * Tk{{$totalCart->price}}</p>
                      </div>
              ...
              <div class="aa-search-box">
                <form action="">
                  ...
                  <button type="button" onclick="funSrarch()"><span class="fa fa-search"></span></button>
                </form>
              </div>
              <!-- / search box -->             
            </div>
      ...
      <div class="modal-content">                      
        ...
        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
          ...
          <input type="email" placeholder="email" name="str_login_email" value="{{$login_email}}" required>
            ...
            <input type="checkbox" id="rememberme" name="rememberme" {{$is_remember}}> Remember me </label>
            
            <div id="login_msg" style="clear:both; color:red;"></div>
